 ...
 * Top element is the minimum value
...
public class MinHeap<T extends Comparable<T>> implements HeapInterface<T> {
    ...
    private void siftDown(int index) {
        ...
        while (index < half) {
            ...
            // If right child exists and is less than left child, use right child
            if (rightIndex < size && 
            ...
            // If current element is less than or equal to child, heap property is satisfied
